...
write_csv(filt1, "raw_data/filtsinoa.csv")
write_csv(filt2, "raw_data/filtsinob.csv")
...
```{r}
 p <- read.csv("C:/Users/capa01/Documents/R-Projects/ANN_work/clean_data/FBP1.csv")
p <- p %>% as.matrix()
image(p)
```
...
##error <- matrix(nrow = 1, ncol = 0)
##error <- c(error, nn$result.matrix[i])
