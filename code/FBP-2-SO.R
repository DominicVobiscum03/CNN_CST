...
##Side by side separate convolutions
...
FBP1tot <- iradon(filt1comb, XSamples = 64, YSamples = 64, mode = "CNF")
...
#Filter 1
filt1a <- read.csv("C:/Users/sumloan/Documents/ANN_work/CNN_CST/raw_data/filtsinoa2-SO.csv")
filt1a <- as.matrix(filt1a)
image(filt1a)

#Filter 2
filt2a <- read.csv("C:/Users/sumloan/Documents/ANN_work/CNN_CST/raw_data/filtsinob2-SO.csv")
filt2a <- as.matrix(filt2a)
image(filt2a)

# Back Projection

#Filter 1 back projection
FBP1tot <- iradon(filt1a, XSamples = 64, YSamples = 64, mode = "BF")
filt1totdata <- FBP1tot$irData
image(filt1totdata)

#Filter 2 back projection
FBP2tot <- iradon(filt2a, XSamples = 64, YSamples = 64, mode = "BF")
filt2totdata <- FBP2tot$irData
image(filt2totdata)
