...
for(val in 1:number_cols){
                    ...
                    filt_sinoA2[91:181, val] <- convolve(sino[91:181, val], m1[2:92, 1], type = "circular")
}
...
write_csv(filt_sinoA2, "raw_data/filtsinoa2b-SO.csv")
write_csv(filt_sinoA_final, "raw_data/filtsinoa-final-SO.csv")


for(val in 1:number_cols){
                   filt_sinoB[1:91,val] <- convolve(sino[1:91,val], m1[2:92,2], type = "circular") 
                   filt_sinoB2[91:181, val] <- convolve(sino[91:181, val], m1[2:92, 2], type = "circular")
} #removed m1[1:91,2]
...
write_csv(filt_sinoB2, "raw_data/filtsinob2b-SO.csv")
write_csv(filt_sinoB_final, "raw_data/filtsinob-final-SO.csv")
