...
FBP1 <- iradon(filt1, XSamples = 300, YSamples = 300, mode = "BF")
filt1data <- FBP1$irData
image(filt1data)

FBP2 <- iradon(filt2, XSamples = 300, YSamples = 300, mode = "BF")
...
b1 <- matrix(m1[1,1], 300, 300)
b2 <- matrix(m1[1,2], 300, 300)
...
filtsa <- matrix(nrow = 300, ncol = 300)
...
filtsb <- matrix(nrow = 300, ncol =300)
...
filtfull <- matrix(nrow =300, ncol = 300)
